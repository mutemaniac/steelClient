...
func NewRoutesApiWithBasePath(basePath string) *RoutesApi {
	...
	configuration.SteelServer = basePath
...
func NewRoutesApiWithBasePathAndSteelServer(basePath string, steelServer string) *RoutesApi {
	configuration := NewConfiguration()
	configuration.BasePath = basePath
	configuration.SteelServer = steelServer
